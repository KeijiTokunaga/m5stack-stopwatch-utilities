...
int main(){
 ...
 s.selected=4;s.next();assert(s.selected==0);
 for(int row=0;row<5;++row)assert(s.hit(233,112+row*53)==row);
 assert(s.hit(87,130)==-1&&s.hit(378,130)==-1&&s.hit(233,156)==-1&&s.hit(233,377)==-1);
